...
const ChickenSides  = () => {
  ...
  const chickenMenu = useSelector((state) => state.menu.chickenMenu || []);
  ...
  const items = chickenMenu.filter((item) => item.category === selectedSubCategory);
